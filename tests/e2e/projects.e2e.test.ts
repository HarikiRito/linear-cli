...
describe.skipIf(!RUN_E2E)('projects E2E', () => {
  it(
    'projects list --json exits 0 and returns projects array with pageInfo',
    async () => {
  ...
  it(
    'projects list --limit 1 --json returns at most 1 project',
    async () => {
  ...
  it(
    'projects list rows have id, name, state fields when present',
    async () => {
