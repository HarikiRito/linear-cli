...
describe.skipIf(!RUN_E2E)('teams E2E', () => {
  it(
    'teams list --json exits 0 and returns at least one team with id/name/key',
    async () => {
  ...
  it(
    'teams list --limit 1 --json returns at most 1 team',
    async () => {
  ...
  it(
    'teams list --all --json returns same first team as single-page call',
    async () => {
